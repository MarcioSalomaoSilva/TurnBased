...
using UnityEngine;
public class Three_Stats : MonoBehaviour {
    public static Three_Stats instance;
    [HideInInspector]
    ...
    public void GetStats() {
        ...
        level = Start_Battle.instance.three.level;
        stats = GetCharacterStats(Start_Battle.instance.three, Start_Battle.instance.three.level);
        CreateStats();
        health = stats[0];
        maxHealth = health;
        magic = stats[1];
